...
{/* BLOG TOP BAR / CLOSE BUTTON */}
<div className="blog-top-bar">
  <Link to="/blogs" className="blog-close-button" aria-label="Close article and return to blogs">
...
>
  Five Most Dangerous Trends Facing Manufacturers
</h2>
  ...
  >
 How to deal with Cyber Security issues?</h2>
  ...
  >
 How to deal with Supply chain issues?</h2>
  ...
  >
 How to deal with Skill Shortage?</h2>
  ...
  >
How to deal with Environmental Regulations?</h2>
  ...
  >
How to deal with Changing Customer preferences?</h2>
...
<p>Contact us at <a href="mailto:support@meghaai.in">support@meghaai.in</a> if you need a free consulting on the above topics and also on  how we can help you find the optimization you are looking for in your manufacturing.</p>
         </section>
